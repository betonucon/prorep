                ...
                <table id="datafixedheader" class="table table-striped table-bordered table-td-valign-middle">
                    <thead>
                        <tr>
                            ...
                            <th class="text-nowrap" width="12%">Otorisasi</th>
                            <th class="text-nowrap" width="9%">Act</th>
                        </tr>
                    </thead>
                    <tbody>
                    
                        @foreach(user_get() as $no=>$data)
                            <tr class="odd gradeX">
                                <td>{{$no+1}}</td>
                                <td>{{$data->username}}</td>
                                <td>{{$data->name}}</td>
                                ...
                                <td>
                                    <span onclick="ubah(`{{$data->username}}`)" class="btn btn-purple active btn-xs"><i class="fas fa-edit fa-sm"></i> View</span> 
                                </td>
                            </tr>
                        @endforeach
