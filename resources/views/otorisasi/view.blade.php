...
@section('conten')   
    <div id="content" class="content">
        ...
        <h1 class="page-header">{{$menu}} {{selisih_bulan($data->project['startdate'],$data->project['enddate'])}}<small>{{name()}}</small></h1>
        <div class="profile">
			<div class="profile-header">
				...
				<div class="profile-header-content">
					...
					<div class="profile-header-info">
						...
						<p class="mb-2">Startdate - Endtdate: {{$data->project['startdate']}} To {{$data->project['enddate']}}</p>
        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                ...
                @for($x=0;$x<selisih_bulan($data->project['startdate'],$data->project['enddate']);$x++)
                    <?php
                        if(bulanberikutnya($data->project['startdate'],$data->project['enddate'],$x)==$periode){
                            $aktif="active";
                        }else{
                            $aktif="";
                        }
                    ...
                    <li class="nav-item" style="background: #eaeaf1;border-right: #fff solid 2px;">
                        <a href="#default-tab-1" onclick="progresisi(`{{bulanberikutnya($data->project['startdate'],$data->project['enddate'],$x)}}`)" data-toggle="tab" class="nav-link {{$aktif}}">
                            <span class="d-sm-none">Tab 1</span>
                            <span class="d-sm-block d-none">{{periode(bulanberikutnya($data->project['startdate'],$data->project['enddate'],$x))}}</span>
                        </a>
                    </li>
                @endfor   
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade active show" id="default-tab-1">
                        <h3 class="m-t-10"><i class="fa fa-cog"></i> {{periode($periode)}}</h3>
                                    ...
                                    @for($kal=1;$kal<=kalender($periode);$kal++)
                                        ...
                                        <tr class="{{$col}}">
                                            ...
                                            @if(cek_aktifitas($data->id,$tgl)>0)
                                                <td style="background: #fff;">{!!aktifitas($data->id,$tgl)!!}</td>
