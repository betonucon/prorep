                ...
                <div class="col-xl-8 ui-sortable">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="chart-js-1">
                        <div class="panel-heading ui-sortable-handle">
                            <h4 class="panel-title">{{$costcenter_get->name}}</h4>
                        ...
                        <div class="panel-body">
                            ...
                            <div>
                                ...
                                <canvas id="bar-chart{{$costcenter_get->id}}" data-render="chart-js" width="495" height="247" style="display: block; width: 495px; height: 247px;" class="chartjs-render-monitor"></canvas>
                            </div>
                        </div>
                    </div>
                    <!-- end panel -->
                    ...
                    <div class="panel panel-inverse" data-sortable-id="chart-js-2" >
                        ...
                        <div class="panel-body">
                            <div class="widget-chart-info" id="style-3" style="height: 387px;overflow-y:scroll">
                                ...
                                @foreach(dashboard_project_get($costcenter_get->id) as $no=>$project_get)
...
@push('ajax')
    <script>
        ...
        */
        ...
        @foreach(costcenter_get() as $costcenter_get)
            var barChartData{{$costcenter_get->id}} = {
                labels: [
                    @foreach(dashboard_project_get($costcenter_get->id) as $no=>$project_get)
                        '{{$project_get->name}}',
                    @endforeach
        ...
        var handleChartJs = function() {
            ...
            // });
            @foreach(costcenter_get() as $costcenter_get)
                var ctx2 = document.getElementById('bar-chart{{$costcenter_get->id}}').getContext('2d');
                var barChart = new Chart(ctx2, {
                    type: 'bar',
                    data: barChartData{{$costcenter_get->id}}
                });
            @endforeach
